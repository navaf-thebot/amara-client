  ...
  const pillars = [
    {
      icon: Eye,
      title: "Transparency",
      description: "We believe in open communication, clear reporting, and honest disclosure of all material information to our stakeholders.",
      color: "from-blue-500 to-blue-600",
      stats: "100% Open Reporting"
    },
    {
      icon: Shield,
      title: "Accountability",
      description: "Every action we take is backed by responsibility, ensuring that we answer for our decisions and their consequences.",
    ...
    },
    {
      icon: Scale,
      title: "Ethics",
      description: "Unwavering moral principles guide our conduct, ensuring fairness, honesty, and integrity in all our dealings.",
      color: "from-purple-500 to-purple-600",
      stats: "Ethical Leadership"
    },
    {
      icon: Leaf,
      title: "Sustainability",
      description: "We are committed to practices that ensure long-term value creation while protecting our planet for future generations.",
  ...
  const governanceFramework = [
    {
      ...
      description: "Our board comprises independent directors who bring diverse expertise and objective oversight to our operations.",
      icon: Users
    },
    {
      title: "Risk Management",
      description: "Comprehensive risk assessment and mitigation strategies ensure sustainable growth and stakeholder protection.",
      icon: Shield
    },
    {
      title: "Stakeholder Engagement",
      description: "Regular communication and engagement with all stakeholders ensure alignment and mutual value creation.",
      icon: FileText
    }
  ];
    ...
    <div className="min-h-screen bg-[#f0efe2] dark:bg-[#232323] transition-colors duration-300">
          ...
          <div className="text-center">
            ...
            <div className="mt-12 animate-bounce">
              <ChevronRight onClick={() => {
                const el = document.getElementById('section-pillars');
      ...
      <section id="section-pillars" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible['section-pillars'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-xl font-montserrat text-[#232323]/70 dark:text-white/70 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pillars.map((pillar, index) => (
              <div
                key={pillar.title}
                className={`transition-all duration-700 delay-${index * 100} ${isVisible['section-pillars'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              ...
              >
                <div className={`bg-white dark:bg-black p-8 rounded-2xl shadow-lg border border-[#c6a35d]/20 h-full transition-all duration-300 cursor-pointer ${hoveredPillar === index ? 'shadow-2xl -translate-y-2 border-[#c6a35d]/40' : ''
                  ...
                  <div className={`relative w-16 h-16 bg-gradient-to-br ${pillar.color} rounded-2xl flex items-center justify-center mb-6 transition-transform duration-300 ${hoveredPillar === index ? 'scale-110' : ''
                    ...
                    {hoveredPillar === index && (
                      <div className="absolute -inset-2 bg-gradient-to-br from-[#c6a35d]/20 to-transparent rounded-2xl animate-pulse"></div>
                    )}
                  </div>

                  <div className="text-start mb-4">
                    <span className="text-xs font-montserrat font-bold text-[#c6a35d] uppercase tracking-wider">
                      {pillar.stats}
                    </span>
                  </div>
                  ...
                  <p className="font-montserrat text-[#232323]/70 dark:text-white/70 leading-relaxed">
                    {pillar.description}
                  </p>

                  {hoveredPillar === index && (
                    <div className="mt-4 flex items-center text-[#c6a35d] font-montserrat font-medium text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className={`text-center mb-12 transition-all duration-1000 ${isVisible['section-message'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="inline-block p-3 bg-[#c6a35d]/10 rounded-full mb-4">
            ...
            <section className={`bg-gradient-to-br from-[#f0efe2] to-white dark:from-[#232323] dark:to-black rounded-3xl border-l-4 border-[#c6a35d] transition-all duration-1000 ${isVisible['section-message'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              <div className="w-full">
                <TypewriterQuote
                  quote="At House of Amaraa, governance is not merely a compliance requirement—it is the very essence of our corporate identity. We have built our reputation on the bedrock of ethical leadership, transparent operations, and accountable decision-making. Our commitment to these principles ensures that we not only meet but exceed the expectations of our stakeholders, creating sustainable value that stands the test of time."
                  cite="Board of Directors"
                />
              </div>
            </section>
              ...
              <div className="space-y-8">
                {governanceFramework.map((item) => (
                  <div key={item.title} className="group">
                    <div className="flex items-start space-x-6 p-6 rounded-2xl transition-all duration-300 hover:bg-white dark:hover:bg-black hover:shadow-lg border border-transparent hover:border-[#c6a35d]/20">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bodoni font-bold text-[#232323] dark:text-white mb-3 group-hover:text-[#c6a35d] transition-colors">
                          {item.title}
                        </h3>
                        <p className="font-montserrat text-[#232323]/70 dark:text-white/70 leading-relaxed">
                          {item.description}
                      ...
                      <ChevronRight className="w-5 h-5 text-[#c6a35d] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className={`transition-all duration-1000 delay-300 ${isVisible['section-framework'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              <div className="relative group">
                ...
                <div className="absolute top-6 right-6 bg-white/90 dark:bg-black/90 backdrop-blur-sm p-4 rounded-xl border border-[#c6a35d]/20">
                  <div className="text-2xl font-bodoni font-bold text-[#c6a35d]">25+</div>
                  <div className="text-sm font-montserrat text-[#232323] dark:text-white">Years Excellence</div>
                </div>

                <div className="absolute bottom-6 left-6 bg-white/90 dark:bg-black/90 backdrop-blur-sm p-4 rounded-xl border border-[#c6a35d]/20">
                  <div className="text-2xl font-bodoni font-bold text-[#c6a35d]">100%</div>
                  <div className="text-sm font-montserrat text-[#232323] dark:text-white">Compliance</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-[#c6a35d]/10 to-transparent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/investors/financial-information">
            <button className="inline-flex cursor-pointer items-center px-8 py-3 bg-[#c6a35d] hover:bg-[#c6a35d]/90 text-white font-montserrat font-semibold rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg">
              View Annual Reports
