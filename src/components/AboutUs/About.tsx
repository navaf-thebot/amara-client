      ...
      <section className="relative min-h-screen flex items-center justify-center">
          ...
          <div className="flex justify-center flex-wrap gap-6">
            {sections.map((section, index) => (
              <button
                ...
                className={`font-montserrat cursor-pointer group relative px-8 py-4 capitalize text-base font-semibold transition-all duration-500 transform hover:scale-110 overflow-hidden ${activeSection === section
                    ? 'text-white'
              ...
              >
                <div className={`absolute inset-0 transition-all duration-500 ${activeSection === section
                    ? 'bg-gradient-to-r from-[#c6a35d] to-[#c6a35d]/80 shadow-lg shadow-[#c6a35d]/30'
                    : 'bg-gradient-to-r from-[#c6a35d]/20 to-[#c6a35d]/10'
                  }`}
                  style={{ clipPath: 'inherit' }} />

                <div className={`absolute inset-0 bg-gradient-to-r from-[#c6a35d] to-[#c6a35d]/80 shadow-lg shadow-[#c6a35d]/30 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out ${activeSection === section ? 'hidden' : ''
                  }`}
                  style={{ clipPath: 'inherit' }} />
        ...
        >
          <div className="flex flex-col items-center">
            <div className="w-7 h-11 border-2 border-[#c6a35d]/60 rounded-full relative mb-2 animate-pulse">
